...
<link rel="stylesheet" href="../css/content.css">
    <title>Category Today In World Page</title>
</head>
<body>
        ...
        <div class="category-list">
            <ul class="list-unstyled list-inline">
                ...
                <li class="list-inline-item"><a class="category-color" href="todayinworld.php">Today in World</a></li>
...
<?php
    ...
    $query = "SELECT * FROM Post, Category WHERE Post.category_id = Category.category_id AND Category.category_name = 'Today in World' AND status = 1";
    ...
    $query = "SELECT * FROM Post, Category WHERE Post.category_id = Category.category_id 
                        AND category_name = 'Today in World' 
                        AND status = 1 
