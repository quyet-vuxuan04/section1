    ...
    <nav class="navbar pl-1 mt-3 navbar-expand-lg col-xl-2">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <select class="form-select fs-5 py-0" onchange="location = this.value;">
                ...
                <option value="todayinworld.php" selected>Today in World</option>
            </select>
        </div>
    </nav>
...
$query = "SELECT * FROM Post, Category WHERE Post.category_id = Category.category_id AND Category.category_name = 'Today in World'";
$result = $conn->query($query);
...
<head>
    ...
    <title>Today in World Admin</title>
</head>
</html>